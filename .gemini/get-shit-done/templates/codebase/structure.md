...
- Usage: Reference from command with `@/home/xenogew/workspace/PropertiesEditor/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/xenogew/workspace/PropertiesEditor/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/xenogew/workspace/PropertiesEditor/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

...
<required_reading>
@/home/xenogew/workspace/PropertiesEditor/.gemini/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/xenogew/workspace/PropertiesEditor/.gemini/get-shit-done/bin/gsd-tools.cjs" init resume)

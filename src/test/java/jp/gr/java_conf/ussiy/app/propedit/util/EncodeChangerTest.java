...
class EncodeChangerTest {
  ...
  class Unicode2UnicodeEsc {
    ...
    @Test
    void japaneseChars() {
      assertEquals("\\u3053\\u3093\\u306b\\u3061\\u306f",
          EncodeChanger.unicode2UnicodeEsc("\u3053\u3093\u306b\u3061\u306f"));
    }
  ...
  class UnicodeEsc2Unicode {
    ...
    void validLowercaseEscape() {
      assertEquals("\u3053\u3093\u306b\u3061\u306f",
          EncodeChanger.unicodeEsc2Unicode("\\u3053\\u3093\\u306b\\u3061\\u306f"));
    }
  ...
  class RoundTrip {
    ...
    void japaneseRoundTrip() {
      ...
      assertEquals(original,
          EncodeChanger.unicodeEsc2Unicode(EncodeChanger.unicode2UnicodeEsc(original)));
    }

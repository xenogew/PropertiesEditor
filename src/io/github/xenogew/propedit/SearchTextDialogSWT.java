...
public class SearchTextDialogSWT extends BaseDialogSWT {
  ...
  public SearchTextDialogSWT(Shell parent) {
    super(parent, PropertiesEditor.getI18nProperty("findMenuItem_Text"));
  }
  ...
  public String open() {
    ...
    label.setText(PropertiesEditor.getI18nProperty("jLabel1_Text2"));
    ...
    searchButton.setText(PropertiesEditor.getI18nProperty("findMenuItem_Text"));

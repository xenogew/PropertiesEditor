...
import io.github.xenogew.propedit.swing.JFontChooserDialog;
import io.github.xenogew.propedit.swing.filechooser.PropertiesFileFilter;
import io.github.xenogew.propedit.util.AlreadyFileLockException;
...
public class PropertiesEditorFrame extends JFrame implements ActionListener {
  ...
  private void jbInit() throws Exception {
    ...
    newMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('N', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    ...
    openMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('O', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    ...
    unicodeSaveMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('S', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    ...
    undoMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('Z', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    ...
    redoMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('Y', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    ...
    cutMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('X', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    ...
    copyMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('C', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    ...
    pasteMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('V', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    ...
    findMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('F', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    ...
    replaceMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('R', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    ...
    selectAllMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('A', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    selectAllMenuItem.addActionListener(e -> selectAllMenuItem_actionPerformed(e));
    toolBar.setFloatable(false);
    wordWrapCheckBoxMenuItem.setEnabled(false);
    wordWrapCheckBoxMenuItem
        .setText(PropertiesEditor.getI18nProperty("wordWrapCheckBoxMenuItem_Text")); //$NON-NLS-1$
    lineNumberCheckBoxMenuItem.setIcon(lineNumImage16);
    lineNumberCheckBoxMenuItem
        .setText(PropertiesEditor.getI18nProperty("lineNumberCheckBoxMenuItem_Text")); //$NON-NLS-1$
    lineNumberCheckBoxMenuItem
        .addActionListener(e -> lineNumberCheckBoxMenuItem_actionPerformed(e));
    toolbarCheckBoxMenuItem
        .setText(PropertiesEditor.getI18nProperty("toolbarCheckBoxMenuItem_Text")); //$NON-NLS-1$
    ...
    showLineNumberButton
        .setToolTipText(PropertiesEditor.getI18nProperty("showLineNumberButton_ToolTipText")); //$NON-NLS-1$
    ...
    saveUnicodeButton
        .setToolTipText(PropertiesEditor.getI18nProperty("saveUnicodeButton_ToolTipText")); //$NON-NLS-1$
    ...
    showUnicodeMenuItem.setAccelerator(
        javax.swing.KeyStroke.getKeyStroke('U', java.awt.event.KeyEvent.CTRL_DOWN_MASK, false));
    ...
    unicodeSaveWithNameMenuItem
        .setText(PropertiesEditor.getI18nProperty("unicodeSaveWithNameMenuItem_Text")); //$NON-NLS-1$
    unicodeSaveWithNameMenuItem
        .addActionListener(e -> unicodeSaveWithNameMenuItem_actionPerformed(e));
  ...
  void openFile(File file, String code) {
    ...
    try {
      ...
      JOptionPane.showMessageDialog(this, PropertiesEditor.getI18nProperty("KEY3"), //$NON-NLS-1$
          PropertiesEditor.getI18nProperty("KEY4"), JOptionPane.ERROR_MESSAGE); //$NON-NLS-1$
      LOG.log(Level.SEVERE, e.getMessage(), e);
      opFp = opFpBuk;
      return;
    }
  ...
  boolean checkSave() {
    ...
    if (undo.canUndo()) {
      ...
      int ret = JOptionPane.showConfirmDialog(this, PropertiesEditor.getI18nProperty("KEY6"), //$NON-NLS-1$
          PropertiesEditor.getI18nProperty("KEY7"), JOptionPane.YES_NO_CANCEL_OPTION); //$NON-NLS-1$
  ...
  private void nextTextSearch(boolean newFlag) {
    ...
    if (targetIndex == -1) {
      if (searchStartPossition == 0) {
        JOptionPane.showConfirmDialog(this, PropertiesEditor.getI18nProperty("KEY8"), "", //$NON-NLS-1$ //$NON-NLS-2$
            JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
        return;
      } else {
        int ret = JOptionPane.showConfirmDialog(this, PropertiesEditor.getI18nProperty("KEY8"), "", //$NON-NLS-1$ //$NON-NLS-2$
            JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
  ...
  private void replace() {
    ...
    JOptionPane.showMessageDialog(this, cnt + PropertiesEditor.getI18nProperty("KEY9"), //$NON-NLS-1$
        PropertiesEditor.getI18nProperty("KEY10"), JOptionPane.INFORMATION_MESSAGE); //$NON-NLS-1$
  }
  ...
  public boolean writeFile() {
    ...
    if (JFileChooser.APPROVE_OPTION == ret) {
      ...
      if (file.exists() && file.isFile()) {
        ret = JOptionPane.showConfirmDialog(this, PropertiesEditor.getI18nProperty("KEY11"), //$NON-NLS-1$
            PropertiesEditor.getI18nProperty("KEY12"), JOptionPane.YES_NO_OPTION, //$NON-NLS-1$
  ...
  public boolean writeFile(String filepath) {
    ...
    try {
      ...
      JOptionPane.showMessageDialog(this, PropertiesEditor.getI18nProperty("KEY13"), //$NON-NLS-1$
          PropertiesEditor.getI18nProperty("KEY4"), JOptionPane.ERROR_MESSAGE); //$NON-NLS-1$
      return false;
    } catch (Exception e) {
      LOG.log(Level.SEVERE, e.getMessage(), e);
      JOptionPane.showMessageDialog(this, PropertiesEditor.getI18nProperty("KEY14"), //$NON-NLS-1$
          PropertiesEditor.getI18nProperty("KEY4"), JOptionPane.ERROR_MESSAGE); //$NON-NLS-1$
      return false;
    }
  }
  ...
  void printMenuItem_actionPerformed(ActionEvent e) {
    ...
    Thread t = new Thread(() -> {
      ...
      try {
        ...
        JOptionPane.showMessageDialog(PropertiesEditorFrame.this,
            PropertiesEditor.getI18nProperty("KEY16") + pe.getMessage()); //$NON-NLS-1$
      }
    });
    t.start();
  }
    ...
    for (var lf : lfInfo) {
      if (e.getActionCommand().equals(lf.getName())) {
        try {
          ...
          JOptionPane.showMessageDialog(this, PropertiesEditor.getI18nProperty("_LookAndFeel_"), //$NON-NLS-1$
              PropertiesEditor.getI18nProperty("KEY4"), JOptionPane.ERROR_MESSAGE); //$NON-NLS-1$
          LOG.log(Level.SEVERE, ex.getMessage(), ex);
        } catch (Exception ex) {
          JOptionPane.showMessageDialog(this, PropertiesEditor.getI18nProperty("LookAndFeel_"), //$NON-NLS-1$
              PropertiesEditor.getI18nProperty("KEY4"), JOptionPane.ERROR_MESSAGE); //$NON-NLS-1$
          LOG.log(Level.SEVERE, ex.getMessage(), ex);
        }
      }

...
import io.github.xenogew.propedit.BaseDialog;
...
public class JFontChooserDialog extends BaseDialog {
  ...
  private static final String[] fontSizeList = {"7", "8", "9", "10", "11", "12", "14", "16", "18", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$
      "20", "22", "24", "26", "28", "36", "48", "72"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$
  ...
  public JFontChooserDialog(Frame frame, Font selectFont, Color selectForegroundColor,
      Color selectBackgroundColor, boolean modal) {
  ...
  private void jbInit() throws Exception {
    ...
    jPanel1.add(jPanel5, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
        GridBagConstraints.BOTH, new Insets(0, 4, 4, 4), 390, 219));
  ...
  public Font getSelectedFont() {
    ...
    int fontStyle =
        this.getFontStyleCodeByFontStyleString((String) styleComboBox.getSelectedItem());
  ...
  private void styleComboBox_actionPerformed(ActionEvent e) {
    ...
    Font f = sampleTextField.getFont();
    Font newFont = new Font(f.getFontName(),
        getFontStyleCodeByFontStyleString((String) styleComboBox.getSelectedItem()), f.getSize());
    sampleTextField.setFont(newFont);
  }
  ...
  private void sizeComboBox_actionPerformed(ActionEvent e) {
    ...
    Font f = sampleTextField.getFont();
    Font newFont = new Font(f.getFontName(), f.getStyle(),
  ...
  private void selectForegroundButton_actionPerformed(ActionEvent e) {
    ...
    Color selectedColor =
        JColorChooser.showDialog(this, res.getString("colorchooser_title"), defaultForegroundColor); //$NON-NLS-1$
  ...
  private void selectBackgroundButton_actionPerformed(ActionEvent e) {
    ...
    Color selectedColor =
        JColorChooser.showDialog(this, res.getString("colorchooser_title"), defaultBackgroundColor); //$NON-NLS-1$
    if (selectedColor == null) {
      return;
    }

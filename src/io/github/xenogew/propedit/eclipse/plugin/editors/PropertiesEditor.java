...
import io.github.xenogew.propedit.eclipse.plugin.preference.PropertiesEditorPreference;
...
public class PropertiesEditor extends TextEditor {
  ...
  public void createPartControl(Composite parent) {
    ...
    if (!PropertiesEditorPlugin.getDefault().getPreferenceStore()
        .getBoolean(PropertiesEditorPreference.P_COLLAPSE)) {
      return;
    }
  ...
  protected void initializeKeyBindingScopes() {
    setKeyBindingScopes(new String[] {"io.github.xenogew.propedit.PropertiesEditorScope"}); //$NON-NLS-1$
  }

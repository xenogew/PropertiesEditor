...
public class ReplaceTextDialogSWT extends BaseDialogSWT {
  ...
  public ReplaceTextDialogSWT(Shell parent) {
    super(parent, PropertiesEditor.getI18nProperty("replaceMenuItem_Text"));
  }
  ...
  public ReplaceResult open() {
    ...
    sourceLabel.setText(PropertiesEditor.getI18nProperty("jLabel1_Text1"));
    ...
    exchangeLabel.setText(PropertiesEditor.getI18nProperty("jLabel2_Text"));
    ...
    replaceButton.setText(PropertiesEditor.getI18nProperty("replaceMenuItem_Text"));
    ...
    cancelButton.setText(PropertiesEditor.getI18nProperty("KEY17"));

...
This project is a collection of Eclipse IDE plugins.
...
- **Asciidoc Functionality**: As much as possible, Asciidoc functionality should be implemented via the LSP (Language Server Protocol) functionality.
...
- **Testing**: Test fragments use JUnit and are executed by `tycho-surefire-plugin` during the build.

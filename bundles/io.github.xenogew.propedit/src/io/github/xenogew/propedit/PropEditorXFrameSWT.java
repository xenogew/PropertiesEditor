...
public class PropEditorXFrameSWT {

  private static final Logger LOG = Logger.getLogger(PropEditorXFrameSWT.class.getName());
  ...
  public PropEditorXFrameSWT(Display display) {
    shell = new Shell(display);
    shell.setText("PropEditorX");
    shell.setImage(new Image(display,
        PropEditorXFrameSWT.class.getResourceAsStream("resource/icon-prop-editor-x-32.png")));
  ...
  private void createMenu() {
    ...
    openItem.setText(PropEditorX.getI18nProperty("openMenuItem_Text") + "\tCtrl+O");
    openItem.setAccelerator(SWT.MOD1 | 'O');
    openItem.addListener(SWT.Selection, e -> selectOpenFile());

    MenuItem saveItem = new MenuItem(fileMenu, SWT.PUSH);
    saveItem.setText(PropEditorX.getI18nProperty("unicodeSaveMenuItem_Text") + "\tCtrl+S");
    saveItem.setAccelerator(SWT.MOD1 | 'S');
    saveItem.addListener(SWT.Selection, e -> saveFile());

    MenuItem printItem = new MenuItem(fileMenu, SWT.PUSH);
    printItem.setText(PropEditorX.getI18nProperty("printMenuItem_Text") + "\tCtrl+P");
    ...
    closeItem.setText(PropEditorX.getI18nProperty("closeMenuItem_Text"));
    ...
    editMenuHeader.setText(PropEditorX.getI18nProperty("editMenu_Text"));
    Menu editMenu = new Menu(shell, SWT.DROP_DOWN);
    editMenuHeader.setMenu(editMenu);

    MenuItem findItem = new MenuItem(editMenu, SWT.PUSH);
    findItem.setText(PropEditorX.getI18nProperty("findMenuItem_Text") + "\tCtrl+F");
    ...
    replaceItem.setText(PropEditorX.getI18nProperty("replaceMenuItem_Text") + "\tCtrl+R");
    ...
    viewMenuHeader.setText(PropEditorX.getI18nProperty("dispMenu_Text"));
    Menu viewMenu = new Menu(shell, SWT.DROP_DOWN);
    viewMenuHeader.setMenu(viewMenu);

    MenuItem fontItem = new MenuItem(viewMenu, SWT.PUSH);
    fontItem.setText(PropEditorX.getI18nProperty("fontSelectMenuItem_Text"));
    fontItem.addListener(SWT.Selection, e -> selectFont());

    // Help Menu
    MenuItem helpMenuHeader = new MenuItem(menuBar, SWT.CASCADE);
    helpMenuHeader.setText(PropEditorX.getI18nProperty("helpMenu_Text"));
    Menu helpMenu = new Menu(shell, SWT.DROP_DOWN);
    helpMenuHeader.setMenu(helpMenu);

    MenuItem aboutItem = new MenuItem(helpMenu, SWT.PUSH);
    aboutItem.setText(PropEditorX.getI18nProperty("versionMenuItem_Text"));
    aboutItem.addListener(SWT.Selection, e -> new PropEditorXAboutBoxSWT(shell).open());
  }
  ...
  private void createToolBar() {
    ...
    openBtn.setImage(new Image(shell.getDisplay(),
        PropEditorXFrameSWT.class.getResourceAsStream("resource/Open16.png")));
    openBtn.setToolTipText(PropEditorX.getI18nProperty("openMenuItem_Text"));
    ...
    saveBtn.setImage(new Image(shell.getDisplay(),
        PropEditorXFrameSWT.class.getResourceAsStream("resource/Save16.png")));
    saveBtn.setToolTipText(PropEditorX.getI18nProperty("unicodeSaveMenuItem_Text"));
    ...
    findBtn.setImage(new Image(shell.getDisplay(),
        PropEditorXFrameSWT.class.getResourceAsStream("resource/Find16.png")));
    findBtn.setToolTipText(PropEditorX.getI18nProperty("findButton_ToolTipText"));
  ...
  private boolean checkSave() {
    if (isModified) {
      ...
      box.setText(PropEditorX.getI18nProperty("KEY7"));
      box.setMessage(PropEditorX.getI18nProperty("KEY6"));
      int choice = box.open();
      if (choice == SWT.YES) {
        saveFile();
        return true;

...
import io.github.xenogew.propedit.eclipse.plugin.editors.view.outline.PropertiesContentOutlinePage.Segment;
...
class PropertiesOutlineContentProvider implements ITreeContentProvider, IDocumentListener {
  ...
  public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
    if (oldInput != null) {
      IDocument document = this.fContentOutlinePage.fDocumentProvider.getDocument(oldInput);
      if (document != null) {
        try {
    ...
    if (newInput != null) {
      IDocument document = this.fContentOutlinePage.fDocumentProvider.getDocument(newInput);
      if (document != null) {

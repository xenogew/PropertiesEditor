...
public class PropEditorXPreference extends FieldEditorPreferencePage
  ...
  public PropEditorXPreference() {

    super(GRID);
    setPreferenceStore(PropEditorXPlugin.getDefault().getPreferenceStore());
  ...
  public void createFieldEditors() {
    ...
    initialCollapseCheckFieldEditor.setEnabled(PropEditorXPlugin.getDefault().getPreferenceStore()
        .getBoolean(PropEditorXPreference.P_COLLAPSE), collapseGroup);
    ...
    for (IWorkbenchWindow window : workbenchWindow) {
      ...
      for (IWorkbenchPage page : workbenchPage) {
        ...
        for (IEditorReference ref : editorReferences) {
          ...
          if (editorPart instanceof io.github.xenogew.propedit.eclipse.plugin.editors.PropEditorX) {
            RGB rgb =
                PreferenceConverter.getColor(pStore, PropEditorXPreference.P_BACKGROUND_COLOR);
            Color color = new ColorManager().getColor(rgb);
            io.github.xenogew.propedit.eclipse.plugin.editors.PropEditorX editor =
                (io.github.xenogew.propedit.eclipse.plugin.editors.PropEditorX) editorPart;
